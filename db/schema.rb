...
ActiveRecord::Schema[7.0].define(version: 2022_12_05_154818) do
  ...
  create_table "campaigns_ambassadors", force: :cascade do |t|
    ...
    t.string "reward_status", default: "pending"
  ...
  create_table "restaurants_ambassadors", force: :cascade do |t|
    t.bigint "restaurant_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["restaurant_id"], name: "index_restaurants_ambassadors_on_restaurant_id"
    t.index ["user_id"], name: "index_restaurants_ambassadors_on_user_id"
  end
